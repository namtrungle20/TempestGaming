create database TempestGamings
go
...
VALUES 
(4, '2025-03-21 11:00:00', 999.98, 'HoanThanh');

INSERT INTO ChiTietDonHang (MaDonHang, MaSanPham, SoLuong, Gia)
VALUES 
(7, 1, 1, 499.99); -- Đơn hàng 1, sản phẩm PlayStation 5
...
VALUES 
(7, 'Thẻ tín dụng', 999.98, '2025-03-21 11:30:00', 'DaThanhToan'), -- Thanh toán cho đơn hàng 1
(7, 'Tiền mặt', 299.99, '2025-03-21 12:00:00', 'DaThanhToan');     -- Thanh toán cho đơn hàng 2
...
DELETE FROM NguoiDung WHERE Email = 'admin@tempest.com';